...
class SortingPath(str, Enum):
    ...
    IDSHORT = 'idShort'
    ID = 'id'
    ADMINISTRATION_DOT_REVISION = 'administration.revision'
    ADMINISTRATION_DOT_VERSION = 'administration.version'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SortingPath from a JSON string"""
