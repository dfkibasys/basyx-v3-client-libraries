...
class PackageDescription(BaseModel):
    ...
    PackageDescription
    """ # noqa: E501
    aas_ids: Optional[List[Annotated[str, Field(strict=True, max_length=2000)]]] = Field(default=None, alias="aasIds")
    package_id: Optional[Annotated[str, Field(strict=True, max_length=128)]] = Field(default=None, alias="packageId")
    __properties: ClassVar[List[str]] = ["aasIds", "packageId"]
