...
class GetSubmodelsValueResult(BaseModel):
    """
    GetSubmodelsValueResult
    """ # noqa: E501
    paging_metadata: Optional[PagedResultPagingMetadata] = None
    result: Optional[List[SubmodelValue]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": [SubmodelValue.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None
        })
        return _obj
...
GetSubmodelsValueResult.model_rebuild(raise_errors=False)
