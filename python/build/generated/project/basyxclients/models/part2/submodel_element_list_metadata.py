...
class SubmodelElementListMetadata(BaseModel):
    """
    ...
    type_value_list_element: Optional[ModelType] = Field(default=None, alias="typeValueListElement")
    ...
    __properties: ClassVar[List[str]] = ["extensions", "category", "idShort", "displayName", "description", "modelType", "embeddedDataSpecifications", "semanticId", "supplementalSemanticIds", "qualifiers", "kind"]
...
SubmodelElementListMetadata.model_rebuild(raise_errors=False)
