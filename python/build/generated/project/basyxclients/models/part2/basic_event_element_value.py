...
class BasicEventElementValue(BaseModel):
    """
    BasicEventElementValue
    """ # noqa: E501
    observed: ReferenceValue
    __properties: ClassVar[List[str]] = ["observed"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "observed": ReferenceValue.from_dict(obj["observed"]) if obj.get("observed") is not None else None
        })
        return _obj
