...
class SubmodelValue(BaseModel):
    """
    SubmodelValue
    """ # noqa: E501
    submodel_elements: Optional[Annotated[List[SubmodelElement], Field(min_length=1)]] = Field(default=None, alias="submodelElements")
    __properties: ClassVar[List[str]] = ["submodelElements"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "submodelElements": [SubmodelElement.from_dict(_item) for _item in obj["submodelElements"]] if obj.get("submodelElements") is not None else None
        })
        return _obj
