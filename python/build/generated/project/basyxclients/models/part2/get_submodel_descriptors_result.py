...
class GetSubmodelDescriptorsResult(BaseModel):
    """
    GetSubmodelDescriptorsResult
    """ # noqa: E501
    paging_metadata: Optional[PagedResultPagingMetadata] = None
    result: Optional[List[SubmodelDescriptor]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": [SubmodelDescriptor.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None
        })
        return _obj
...
GetSubmodelDescriptorsResult.model_rebuild(raise_errors=False)
