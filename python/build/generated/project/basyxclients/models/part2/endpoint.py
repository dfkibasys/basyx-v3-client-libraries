...
class Endpoint(BaseModel):
    ...
    Endpoint
    """ # noqa: E501
    interface: Annotated[str, Field(strict=True, max_length=128)]
    protocol_information: ProtocolInformation = Field(alias="protocolInformation")
    __properties: ClassVar[List[str]] = ["interface", "protocolInformation"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of protocol_information
        if self.protocol_information:
            _dict['protocolInformation'] = self.protocol_information.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "protocolInformation": ProtocolInformation.from_dict(obj["protocolInformation"]) if obj.get("protocolInformation") is not None else None
        })
        return _obj
