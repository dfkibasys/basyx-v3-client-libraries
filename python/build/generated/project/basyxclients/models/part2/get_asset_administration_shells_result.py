...
class GetAssetAdministrationShellsResult(BaseModel):
    """
    GetAssetAdministrationShellsResult
    """ # noqa: E501
    paging_metadata: Optional[PagedResultPagingMetadata] = None
    result: Optional[List[AssetAdministrationShell]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": [AssetAdministrationShell.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None
        })
        return _obj
...
GetAssetAdministrationShellsResult.model_rebuild(raise_errors=False)
