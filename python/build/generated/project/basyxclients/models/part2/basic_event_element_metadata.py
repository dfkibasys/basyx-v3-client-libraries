...
class BasicEventElementMetadata(BaseModel):
    """
    ...
    state: Optional[StateOfEvent] = None
    message_topic: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, alias="messageTopic")
    ...
    min_interval: Optional[StrictStr] = Field(default=None, alias="minInterval")
    max_interval: Optional[StrictStr] = Field(default=None, alias="maxInterval")
    __properties: ClassVar[List[str]] = ["extensions", "category", "idShort", "displayName", "description", "modelType", "embeddedDataSpecifications", "semanticId", "supplementalSemanticIds", "qualifiers", "kind", "direction", "state", "messageTopic", "messageBroker", "lastUpdate", "minInterval", "maxInterval"]
...
BasicEventElementMetadata.model_rebuild(raise_errors=False)
