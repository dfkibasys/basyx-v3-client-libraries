...
class BlobValue(BaseModel):
    """
    BlobValue
    """ # noqa: E501
    content_type: Annotated[str, Field(min_length=1, strict=True, max_length=100)] = Field(alias="contentType")
    value: StrictStr
    __properties: ClassVar[List[str]] = ["contentType", "value"]
