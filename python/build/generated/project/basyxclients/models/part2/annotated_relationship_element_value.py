...
class AnnotatedRelationshipElementValue(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["first", "second", "annotations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "first": ReferenceValue.from_dict(obj["first"]) if obj.get("first") is not None else None,
            "second": ReferenceValue.from_dict(obj["second"]) if obj.get("second") is not None else None,
