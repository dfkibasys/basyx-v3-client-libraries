...
class Message(BaseModel):
    ...
    Message
    """ # noqa: E501
    code: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=32)]] = None
    correlation_id: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=128)]] = Field(default=None, alias="correlationId")
    message_type: Optional[StrictStr] = Field(default=None, alias="messageType")
    text: Optional[StrictStr] = None
    timestamp: Optional[Annotated[str, Field(strict=True)]] = None
    __properties: ClassVar[List[str]] = ["code", "correlationId", "messageType", "text", "timestamp"]
    ...
    def message_type_validate_enum(cls, value):
        ...
        if value not in set(['Undefined', 'Info', 'Warning', 'Error', 'Exception']):
            raise ValueError("must be one of enum values ('Undefined', 'Info', 'Warning', 'Error', 'Exception')")
        return value
