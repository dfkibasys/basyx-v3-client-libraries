...
class SubmodelMetadata(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["extensions", "category", "idShort", "displayName", "description", "modelType", "administration", "id", "embeddedDataSpecifications", "qualifiers", "semanticId", "supplementalSemanticIds", "kind"]
...
SubmodelMetadata.model_rebuild(raise_errors=False)
