...
class SubmodelDescriptor(BaseModel):
    ...
    supplemental_semantic_id: Optional[Annotated[List[Reference], Field(min_length=1)]] = Field(default=None, alias="supplementalSemanticId")
    endpoints: Annotated[List[Endpoint], Field(min_length=1)]
    __properties: ClassVar[List[str]] = ["description", "displayName", "extensions", "administration", "idShort", "id", "semanticId", "supplementalSemanticId", "endpoints"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in supplemental_semantic_id (list)
        _items = []
        if self.supplemental_semantic_id:
            for _item_supplemental_semantic_id in self.supplemental_semantic_id:
                if _item_supplemental_semantic_id:
                    _items.append(_item_supplemental_semantic_id.to_dict())
            _dict['supplementalSemanticId'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "supplementalSemanticId": [Reference.from_dict(_item) for _item in obj["supplementalSemanticId"]] if obj.get("supplementalSemanticId") is not None else None,
...
SubmodelDescriptor.model_rebuild(raise_errors=False)
