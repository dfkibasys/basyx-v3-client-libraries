...
class AssetAdministrationShellMetadata(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["extensions", "category", "idShort", "displayName", "description", "modelType", "administration", "id", "embeddedDataSpecifications", "derivedFrom"]
...
AssetAdministrationShellMetadata.model_rebuild(raise_errors=False)
