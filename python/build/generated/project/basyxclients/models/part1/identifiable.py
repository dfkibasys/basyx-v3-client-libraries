...
class Identifiable(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["extensions", "category", "idShort", "displayName", "description", "modelType", "administration", "id"]
...
Identifiable.model_rebuild(raise_errors=False)
