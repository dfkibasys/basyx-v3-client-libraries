...
class Extension(BaseModel):
    ...
    value_type: Optional[DataTypeDefXsd] = Field(default=None, alias="valueType")
    value: Optional[StrictStr] = None
    refers_to: Optional[Annotated[List[Reference], Field(min_length=1)]] = Field(default=None, alias="refersTo")
    __properties: ClassVar[List[str]] = ["semanticId", "supplementalSemanticIds", "name", "valueType", "value", "refersTo"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in refers_to (list)
        _items = []
        if self.refers_to:
            for _item_refers_to in self.refers_to:
                if _item_refers_to:
                    _items.append(_item_refers_to.to_dict())
            _dict['refersTo'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": obj.get("value"),
            "refersTo": [Reference.from_dict(_item) for _item in obj["refersTo"]] if obj.get("refersTo") is not None else None
        })
        return _obj
...
Extension.model_rebuild(raise_errors=False)
