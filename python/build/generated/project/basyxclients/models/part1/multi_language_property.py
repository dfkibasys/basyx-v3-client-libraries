...
class MultiLanguageProperty(BaseModel):
    ...
    value: Optional[Annotated[List[LangStringTextType], Field(min_length=1)]] = None
    value_id: Optional[Reference] = Field(default=None, alias="valueId")
    __properties: ClassVar[List[str]] = ["extensions", "category", "idShort", "displayName", "description", "modelType", "semanticId", "supplementalSemanticIds", "qualifiers", "embeddedDataSpecifications", "value", "valueId"]
    ...
    def model_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['MultiLanguageProperty']):
            raise ValueError("must be one of enum values ('MultiLanguageProperty')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [LangStringTextType.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None,
...
MultiLanguageProperty.model_rebuild(raise_errors=False)
