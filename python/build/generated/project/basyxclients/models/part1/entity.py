...
class Entity(BaseModel):
    ...
    statements: Optional[Annotated[List[SubmodelElementChoice], Field(min_length=1)]] = None
    ...
    __properties: ClassVar[List[str]] = ["extensions", "category", "idShort", "displayName", "description", "modelType", "semanticId", "supplementalSemanticIds", "qualifiers", "embeddedDataSpecifications", "statements", "entityType", "globalAssetId", "specificAssetIds"]
    ...
    def model_type_validate_regular_expression(cls, value):
        ...
        if not re.match(r"Entity", value):
            raise ValueError(r"must validate the regular expression /Entity/")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "statements": [SubmodelElementChoice.from_dict(_item) for _item in obj["statements"]] if obj.get("statements") is not None else None,
