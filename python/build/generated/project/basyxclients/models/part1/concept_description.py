...
class ConceptDescription(BaseModel):
    ...
    is_case_of: Optional[Annotated[List[Reference], Field(min_length=1)]] = Field(default=None, alias="isCaseOf")
    __properties: ClassVar[List[str]] = ["extensions", "category", "idShort", "displayName", "description", "modelType", "administration", "id", "embeddedDataSpecifications", "isCaseOf"]
    ...
    def model_type_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"ConceptDescription", value):
            raise ValueError(r"must validate the regular expression /ConceptDescription/")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isCaseOf": [Reference.from_dict(_item) for _item in obj["isCaseOf"]] if obj.get("isCaseOf") is not None else None
        })
        return _obj
