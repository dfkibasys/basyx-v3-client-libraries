...
class Range(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["extensions", "category", "idShort", "displayName", "description", "modelType", "semanticId", "supplementalSemanticIds", "qualifiers", "embeddedDataSpecifications", "valueType", "min", "max"]
    ...
    def model_type_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"Range", value):
            raise ValueError(r"must validate the regular expression /Range/")
        return value
