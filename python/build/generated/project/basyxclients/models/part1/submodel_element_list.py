...
class SubmodelElementList(BaseModel):
    ...
    order_relevant: Optional[StrictBool] = Field(default=None, alias="orderRelevant")
    semantic_id_list_element: Optional[Reference] = Field(default=None, alias="semanticIdListElement")
    type_value_list_element: AasSubmodelElements = Field(alias="typeValueListElement")
    value_type_list_element: Optional[DataTypeDefXsd] = Field(default=None, alias="valueTypeListElement")
    value: Optional[Annotated[List[SubmodelElementChoice], Field(min_length=1)]] = None
    __properties: ClassVar[List[str]] = ["extensions", "category", "idShort", "displayName", "description", "modelType", "semanticId", "supplementalSemanticIds", "qualifiers", "embeddedDataSpecifications", "orderRelevant", "semanticIdListElement", "typeValueListElement", "valueTypeListElement", "value"]
    ...
    def model_type_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"SubmodelElementList", value):
            raise ValueError(r"must validate the regular expression /SubmodelElementList/")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of semantic_id_list_element
        if self.semantic_id_list_element:
            _dict['semanticIdListElement'] = self.semantic_id_list_element.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "orderRelevant": obj.get("orderRelevant"),
            "semanticIdListElement": Reference.from_dict(obj["semanticIdListElement"]) if obj.get("semanticIdListElement") is not None else None,
            "typeValueListElement": obj.get("typeValueListElement"),
            "valueTypeListElement": obj.get("valueTypeListElement"),
            "value": [SubmodelElementChoice.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj

from basyxclients.models.part1.submodel_element_choice import SubmodelElementChoice
# TODO: Rewrite to not use raise_errors
SubmodelElementList.model_rebuild(raise_errors=False)
