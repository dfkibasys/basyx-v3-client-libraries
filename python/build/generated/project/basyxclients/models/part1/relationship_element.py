...
class RelationshipElement(BaseModel):
    ...
    def model_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['RelationshipElement']):
            raise ValueError("must be one of enum values ('RelationshipElement')")
        return value
...
RelationshipElement.model_rebuild(raise_errors=False)
