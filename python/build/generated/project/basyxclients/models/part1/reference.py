...
class Reference(BaseModel):
    ...
    """ # noqa: E501
    type: ReferenceTypes
    keys: Annotated[List[Key], Field(min_length=1)]
    referred_semantic_id: Optional[ReferenceParent] = Field(default=None, alias="referredSemanticId")
    __properties: ClassVar[List[str]] = ["type", "keys", "referredSemanticId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.keys:
            ...
            _dict['keys'] = _items
        # override the default output from pydantic by calling `to_dict()` of referred_semantic_id
        if self.referred_semantic_id:
            _dict['referredSemanticId'] = self.referred_semantic_id.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "referredSemanticId": ReferenceParent.from_dict(obj["referredSemanticId"]) if obj.get("referredSemanticId") is not None else None
        })
        return _obj
...
Reference.model_rebuild(raise_errors=False)
