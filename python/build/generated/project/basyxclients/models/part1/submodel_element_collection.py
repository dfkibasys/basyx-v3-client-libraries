...
class SubmodelElementCollection(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["extensions", "category", "idShort", "displayName", "description", "modelType", "semanticId", "supplementalSemanticIds", "qualifiers", "embeddedDataSpecifications", "value"]
    ...
    def model_type_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"SubmodelElementCollection", value):
            raise ValueError(r"must validate the regular expression /SubmodelElementCollection/")
        return value
...
SubmodelElementCollection.model_rebuild(raise_errors=False)
