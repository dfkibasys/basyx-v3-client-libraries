...
class ReferenceElement(BaseModel):
    ...
    def model_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['ReferenceElement']):
            raise ValueError("must be one of enum values ('ReferenceElement')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": Reference.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
...
ReferenceElement.model_rebuild(raise_errors=False)
