...
class AssetAdministrationShell(BaseModel):
    ...
    def model_type_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"AssetAdministrationShell", value):
            raise ValueError(r"must validate the regular expression /AssetAdministrationShell/")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.asset_information:
            _dict['assetInformation'] = self.asset_information.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "derivedFrom": Reference.from_dict(obj["derivedFrom"]) if obj.get("derivedFrom") is not None else None,
            "assetInformation": AssetInformation.from_dict(obj["assetInformation"]) if obj.get("assetInformation") is not None else None,
            "submodels": [Reference.from_dict(_item) for _item in obj["submodels"]] if obj.get("submodels") is not None else None
        })
        return _obj
