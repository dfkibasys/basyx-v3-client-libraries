...
class AnnotatedRelationshipElement(BaseModel):
    """
    ...
    first: Reference
    second: Reference
    annotations: Optional[Annotated[List[DataElementChoice], Field(min_length=1)]] = None
    __properties: ClassVar[List[str]] = ["extensions", "category", "idShort", "displayName", "description", "modelType", "semanticId", "supplementalSemanticIds", "qualifiers", "embeddedDataSpecifications", "first", "second", "annotations"]
    ...
    def model_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['AnnotatedRelationshipElement']):
            raise ValueError("must be one of enum values ('AnnotatedRelationshipElement')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "annotations": [DataElementChoice.from_dict(_item) for _item in obj["annotations"]] if obj.get("annotations") is not None else None
        })
        return _obj
...
AnnotatedRelationshipElement.model_rebuild(raise_errors=False)
