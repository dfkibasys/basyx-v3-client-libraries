...
class Operation(BaseModel):
    ...
    input_variables: Optional[Annotated[List[OperationVariable], Field(min_length=1)]] = Field(default=None, alias="inputVariables")
    output_variables: Optional[Annotated[List[OperationVariable], Field(min_length=1)]] = Field(default=None, alias="outputVariables")
    inoutput_variables: Optional[Annotated[List[OperationVariable], Field(min_length=1)]] = Field(default=None, alias="inoutputVariables")
    __properties: ClassVar[List[str]] = ["extensions", "category", "idShort", "displayName", "description", "modelType", "semanticId", "supplementalSemanticIds", "qualifiers", "embeddedDataSpecifications", "inputVariables", "outputVariables", "inoutputVariables"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inputVariables": [OperationVariable.from_dict(_item) for _item in obj["inputVariables"]] if obj.get("inputVariables") is not None else None,
            "outputVariables": [OperationVariable.from_dict(_item) for _item in obj["outputVariables"]] if obj.get("outputVariables") is not None else None,
            "inoutputVariables": [OperationVariable.from_dict(_item) for _item in obj["inoutputVariables"]] if obj.get("inoutputVariables") is not None else None
        })
        return _obj
