...
class Qualifier(BaseModel):
    ...
    type: Annotated[str, Field(min_length=1, strict=True, max_length=128)]
    value_type: DataTypeDefXsd = Field(alias="valueType")
    value: Optional[StrictStr] = None
    value_id: Optional[Reference] = Field(default=None, alias="valueId")
    __properties: ClassVar[List[str]] = ["semanticId", "supplementalSemanticIds", "kind", "type", "valueType", "value", "valueId"]
