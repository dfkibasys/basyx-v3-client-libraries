...
class ModelProperty(BaseModel):
    ...
    value_type: DataTypeDefXsd = Field(alias="valueType")
    value: Optional[StrictStr] = None
    value_id: Optional[Reference] = Field(default=None, alias="valueId")
    __properties: ClassVar[List[str]] = ["extensions", "category", "idShort", "displayName", "description", "modelType", "semanticId", "supplementalSemanticIds", "qualifiers", "embeddedDataSpecifications", "valueType", "value", "valueId"]
    ...
    def model_type_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"Property", value):
            raise ValueError(r"must validate the regular expression /Property/")
        return value
