...
public class BasyxTestAssertions {
	...
	public void assertEnvironmentState(String name, BasyxRepositoryState expected) throws IOException, JSONException {
		if (expected != null) {
	...
	private void compareShells(String name, List<AssetAdministrationShell> expectedShellList) throws JsonProcessingException, JSONException {
